...
- **Stub Mode** (`VOXGUARD_ML_MODE=stub`, demo default): Runs deterministic simulated chunk score trajectories for offline testing.
- **Real ML Mode** (`VOXGUARD_ML_MODE=real`): Runs real Spectra-AASIST3 model inference using PyTorch and Hugging Face weights.
