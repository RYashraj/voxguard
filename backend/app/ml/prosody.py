...
def assess_prosody(features: dict) -> dict:
    ...
    # Only flat pitch monotonic synthesis (low_f0_variability) indicates AI vocoder synthesis.
    # Speech pauses and voiced ratio variations are normal human speech dynamics.
